...
list_entry_t pra_list_head;             //Page结构体新加的链表项，构成的链表（按页的第一次访问时间排序）的表头
/*
...
struct swap_manager swap_manager_fifo =
{
     ...
     .tick_event      = &_fifo_tick_event,  //就是return 0就行，不用tick积极替换
     .map_swappable   = &_fifo_map_swappable,   //形成队列
     .set_unswappable = &_fifo_set_unswappable, //就是return 0就行
     .swap_out_victim = &_fifo_swap_out_victim, //找到最老页换出
